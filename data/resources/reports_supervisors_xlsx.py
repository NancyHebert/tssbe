...
class Resource(OptionMixin):
    ...
    def on_get(self, req, resp):
        """
        @api {get} /reports/supervisors.xlsx    Get data about how quickly supervisors are responding, in Excel format
        @apiName GetSupervisorsReportExcel
        @apiGroup Reports

        @apiSuccess {File}  supervisors.xlsx
        """

        # Create the filename for the temporary file
        reports_folder = self.storage_path + "/supervisors/"
