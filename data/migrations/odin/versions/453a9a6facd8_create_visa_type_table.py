...
Revision ID: 453a9a6facd8
Revises: 6dc8ecbe9b15
Create Date: 2016-07-27 18:56:51.134674

"""

# revision identifiers, used by Alembic.
revision = '453a9a6facd8'
down_revision = '6dc8ecbe9b15'
branch_labels = None
depends_on = None
...
def upgrade():
    visa_type = op.create_table(
        ...
        sa.Column('visa_number', sa.Unicode(30), nullable=True),
